...
run_once("/home/user/bin/awesomefix.sh")
-- }}}
...
-- {{{ Tags
tags = {
   names = { "term", "fm", "web", "im", "man", "vnc", "misc" },
...
globalkeys = awful.util.table.join(
    ...
    -- User programs
    awful.key({ altkey }, "F5", function () awful.util.spawn(browser) end),
    awful.key({ altkey }, "F3", function () awful.util.spawn(fm) end),
    awful.key({ altkey }, "s", function () awful.util.spawn(gui_editor) end),
