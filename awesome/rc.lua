...
globalkeys = mytable.join(
    ...
    awful.key({ superkey }, "p", function() os.execute("screenshot") end,
    ...
    awful.key({ superkey }, "Left", function () lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous nonempty", group = "tag"}),
    awful.key({ superkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
              {description = "view  previous nonempty", group = "tag"}),
    ...
    awful.key({ superkey, "Control" }, "+", function () lain.util.useless_gaps_resize(1) end,
    ...
    awful.key({ modkey, superkey    }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey, superkey    }, "h",     function () awful.tag.incmwfact(-0.05)          end,
