...
(def-doom-theme doom-gruvbox-black
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#000000" "#000000" nil))   ; bg0_h
          ((equal doom-gruvbox-dark-variant "soft") '("#000000" "#000000" nil))   ; bg0_s
          (t                                        '("#000000" "#000000" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#000000" "000000" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#000000" "#000000" nil))   ; bg0
          (t                                        '("#000000" "#000000" nil)))) ; bg_h
   (bg-alt2    '("#111111" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#000000" "black"   "black"      )) ; (self-defined)
   (base1      '("#000000" "#1d1d1d" "brightblack")) ; bg0_h
   (base2      '("#000000" "#282828" "brightblack")) ; bg0
