...
(def-doom-theme doom-gruvbox-soft
  "gruvbox light theme"

  ;; name        default   256       16
  ((bg
    (cond ((equal doom-gruvbox-light-variant "hard") '("#f9f5d7" "#ffffd7" nil))   ; bg0_h
          ((equal doom-gruvbox-light-variant "soft") '("#f9f5d7" "#ffffd7" nil))   ; bg0_s
          (t                                         '("#f9f5d7" "#ffffd7" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-light-variant "hard") '("#f9f5d7" "#ffffd7" nil))
          ((equal doom-gruvbox-light-variant "soft") '("#f9f5d7" "#ffffaf" nil))
          (t                                         '("#f9f5d7" "#ffffd7" nil))))
   (base0      '("#f0f0f0" "#f0f0f0" "white"           )) ;;
   (base1      '("#f9f5d7" "#ffffaf" "brightblack"     )) ;; gruvbox-dark1
   (base2      '("#f9f5d7" "#d7d6af" "brightblack"     )) ;; gruvbox-dark2
