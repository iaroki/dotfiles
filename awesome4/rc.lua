...
awful.util.tagnames = { "term", "fm", "web", "disc", "irc", "man", "rmt", "misc" }
...
globalkeys = awful.util.table.join(
    ...
    -- User programs
    awful.key({ altkey }, "F3", function () awful.spawn("thunar") end),
    awful.key({ altkey }, "F5", function () awful.spawn(browser) end),
    awful.key({ altkey }, "F6", function () awful.spawn("/home/hostmorke/bin/DiscordCanary/DiscordCanary") end),
